...
unless defined? Ziya
  module Ziya          
    ...
    def self.initialize( opts={} )
      RAILS_DEFAULT_LOGGER.debug ">>> No logger specified. Using ZiYa default logger" unless opts[:logger]
      RAILS_DEFAULT_LOGGER.debug ">>> No themes_dir specified. Using ZiYa default themes" unless opts[:themes_dir]      
